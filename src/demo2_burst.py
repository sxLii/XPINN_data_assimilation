...
# data
#%%
DFh = pd.read_csv(r'../data/demo2_burst_h.csv')
DFq = pd.read_csv(r'../data/demo2_burst_q.csv')
...
plt.savefig(f'../res/demo2_burst/png/height.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边
...
plt.savefig(f'../res/demo2_burst/png/flow.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边
...
for i in range(pipe_number):
    ...
    plt.tight_layout()
    plt.savefig(f'../res/demo2_burst/png/cour{i+1}.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边
...
## save errors
err_file = f"../res/demo2_burst/err.csv"
...
for i in range(node_number):
    ...
    plt.savefig(f'../res/demo2_burst/png/inter{i + 1}.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边

name1 = r'../res/demo2_burst/all/'
name2 = r'../res/demo2_burst/obs/'
name3 = r'../res/demo2_burst/inter/'
name4 = r'../res/demo2_burst/loss/'
