...
# data
# %%
DFh = pd.read_csv(r'../data/demo2_valve_h.csv')
DFq = pd.read_csv(r'../data/demo2_valve_q.csv')
...
for i in range(pipe_number):
    ...
    # observation data
    idx = np.array([1, 5, -2], dtype='int')  # 5p
...
plt.savefig(f'../res/demo2_valve/png/height.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边
...
plt.savefig(f'../res/demo2_valve/png/flow.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边
...
for i in range(pipe_number):
    ...
    plt.tight_layout()
    plt.savefig(f'../res/demo2_valve/png/cour{i + 1}.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边
...
## save errors
err_file = f"../res/demo2_valve/err.csv"
...
for i in range(node_number):
    ...
    plt.savefig(f'../res/demo2_valve/png/inter.png', dpi=100, bbox_inches='tight')  # 会裁掉多余的白边

name1 = r'../res/demo2_valve/all/'
name2 = r'../res/demo2_valve/obs/'
name3 = r'../res/demo2_valve/inter/'
name4 = r'../res/demo2_valve/loss/'
